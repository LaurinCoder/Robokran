...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        calculateGP->setGeometry(QRect(30, 130, 201, 25));
        showHist = new QCheckBox(tab_5);
        showHist->setObjectName(QStringLiteral("showHist"));
        showHist->setGeometry(QRect(30, 170, 221, 26));
        showSurface = new QCheckBox(tab_5);
        showSurface->setObjectName(QStringLiteral("showSurface"));
        showSurface->setGeometry(QRect(30, 200, 281, 26));
        frame = new QFrame(tab_5);
        frame->setObjectName(QStringLiteral("frame"));
        frame->setGeometry(QRect(10, 120, 511, 351));
        sizePolicy.setHeightForWidth(frame->sizePolicy().hasHeightForWidth());
        frame->setSizePolicy(sizePolicy);
        frame->setFrameShape(QFrame::StyledPanel);
        frame->setFrameShadow(QFrame::Raised);
        xGp = new QLineEdit(frame);
        xGp->setObjectName(QStringLiteral("xGp"));
        xGp->setGeometry(QRect(20, 260, 113, 28));
        xGp->setReadOnly(true);
        yGp = new QLineEdit(frame);
        yGp->setObjectName(QStringLiteral("yGp"));
        yGp->setGeometry(QRect(160, 260, 113, 28));
        yGp->setReadOnly(true);
        zGp = new QLineEdit(frame);
        zGp->setObjectName(QStringLiteral("zGp"));
        zGp->setGeometry(QRect(300, 260, 113, 28));
        zGp->setReadOnly(true);
        label = new QLabel(frame);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(30, 230, 80, 20));
        label_2 = new QLabel(frame);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(170, 230, 80, 20));
        label_3 = new QLabel(frame);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(310, 230, 80, 20));
        enSopas = new QCheckBox(frame);
        enSopas->setObjectName(QStringLiteral("enSopas"));
        enSopas->setGeometry(QRect(20, 110, 281, 26));
        enPoendorf = new QCheckBox(frame);
        enPoendorf->setObjectName(QStringLiteral("enPoendorf"));
        enPoendorf->setGeometry(QRect(20, 140, 281, 26));
        label_12 = new QLabel(frame);
        label_12->setObjectName(QStringLiteral("label_12"));
        label_12->setGeometry(QRect(30, 200, 251, 20));
        QFont font3;
        font3.setBold(true);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        enSopas->setText(QApplication::translate("MainWindow", "Sopas Scan", Q_NULLPTR));
        enPoendorf->setText(QApplication::translate("MainWindow", "P\303\266ndorf Scan", Q_NULLPTR));
