...
//    Q_OBJECT
public:
    //    explicit Diagramm(QImage heightMapImage);
    //    ~Diagramm();
    //    Diagramm(QImage heightMapImage, QSurfaceDataArray* dataArray = nullptr)
    Diagramm (){}
    void operator()(const std::string & heightMapImage_string, std::vector<std::vector<long> >& data_X, std::vector<std::vector<long> >& data_Z, std::vector<std::vector<long> >& data_Y)
    {
        QImage heightMapImage = QImage(QString::fromStdString(heightMapImage_string));
...
//        widget->setWindowTitle(QStringLiteral("Surface example"));
        widget->setWindowTitle(QStringLiteral("Display"));

        QGroupBox *modelGroupBox = new QGroupBox(QStringLiteral("Model"));

//        QRadioButton *sqrtSinModelRB = new QRadioButton(widget);
        QRadioButton *xyzSurfaceModelRB = new QRadioButton(widget);
//        sqrtSinModelRB->setText(QStringLiteral("Sqrt && Sin"));
        xyzSurfaceModelRB->setText(QStringLiteral("X/Y/Z Surface"));
//        sqrtSinModelRB->setChecked(false);
        xyzSurfaceModelRB->setChecked(false);
...
//        modelVBox->addWidget(sqrtSinModelRB);
        modelVBox->addWidget(xyzSurfaceModelRB);
        ...
        widget->show();//    system("sleep 100");
        SurfaceGraph *modifier = new SurfaceGraph(graph, heightMapImage, data_X, data_Y, data_Z);
...
//        QObject::connect(sqrtSinModelRB, &QRadioButton::toggled,      modifier, &SurfaceGraph::enableSqrtSinModel);
        QObject::connect(xyzSurfaceModelRB, &QRadioButton::toggled,      modifier, &SurfaceGraph::enableXYZSurfaceModel);
...
//        sqrtSinModelRB->setChecked(true);
        xyzSurfaceModelRB->setChecked(true);
